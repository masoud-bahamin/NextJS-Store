                ...
                <div className="-mx-4 flex flex-wrap">
                    ...
                    <div className="w-full px-4 lg:w-7/12">
                        {comments?.slice(0,3).map(comment => (
                            <div key={comment._id} className="mb-9 overflow-hidden rounded-lg bg-white shadow-card">
                                        ...
                                        <div className="w-full px-3">
                                            <div className="mb-6">
                                                <textarea ref={inputRef}
                                                    rows="6" placeholder="Write your Review" className="w-full rounded-lg border border-[#e7e7e7] bg-[#f4f7ff] py-3 px-6 font-medium text-slate-700 placeholder-slate-700 outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-[#F5F7FD]"></textarea>
                                            </div>
                                        </div>
                                        <div className="w-full px-3">
                                            <div>
