                                ...
                                <div className="mr-3 flex items-center">
                                    <span className="mr-1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18.6563 7.46875L13 6.59375L10.4375 1.21875C10.25 0.84375 9.75001 0.84375 9.56251 1.21875L7.00001 6.625L1.37501 7.46875C0.968761 7.53125 0.812511 8.0625 1.12501 8.34375L5.21876 12.5625L4.25001 18.4688C4.18751 18.875 4.59376 19.2188 4.96876 18.9688L10.0625 16.1875L15.125 18.9688C15.4688 19.1562 15.9063 18.8438 15.8125 18.4688L14.8438 12.5625L18.9375 8.34375C19.1875 8.0625 19.0625 7.53125 18.6563 7.46875Z" fill="#FFA645"></path>
                                        </svg>
                                    </span>
                                    <span className="mr-1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-full px-4 lg:w-7/12">
                        <div className="mb-9 overflow-hidden rounded-lg bg-white shadow-card">
                            <div className="py-8 px-6 sm:py-10 md:px-8 xl:px-10">
                                <h4 className="mb-4 text-lg font-bold text-black sm:text-xl">
                                    Quality was not good but it can be better.
                                </h4>
                            ...
                            <div className="items-center justify-between border-t border-[#e7e7e7] px-6 pt-4 md:flex md:px-8 xl:px-10">
                                <div className="mb-4 flex items-center">
                                    <div className="mr-4 h-10 w-10 overflow-hidden rounded-full">
                                        <img src="/img/image-01.png" alt="author" className="h-full w-full object-cover object-center" />
                                    </div>
                                ...
                                <div className="mb-4 flex items-center space-x-4">
                                    <button className="flex items-center text-slate-700 hover:text-blue-600">
                                        <span className="mr-1">
                                    ...
                                    <button className="text-base font-medium text-slate-700 hover:text-blue-600">
                                        Reply
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="mb-9 overflow-hidden rounded-lg bg-white shadow-card">
                            ...
                            <div className="items-center justify-between border-t border-[#e7e7e7] px-6 pt-4 md:flex md:px-8 xl:px-10">
                                <div className="mb-4 flex items-center">
                                    <div className="mr-4 h-10 w-10 overflow-hidden rounded-full">
                                        <img src="/img/image-02.png" alt="author" className="h-full w-full object-cover object-center" />
                                    </div>
                                    <div className="flex items-center">
                                        <h3 className="pr-2 text-lg font-medium text-black">
                                            Jemmy Delium
                                ...
                                <div className="mb-4 flex items-center space-x-4">
                                    <button className="flex items-center text-slate-700 hover:text-blue-600">
                                        ...
                                        <span className="text-base font-medium"> 5 of 5 </span>
                                    </button>
                                    <button className="flex items-center text-slate-700 hover:text-blue-600">
                                        <span className="mr-1">
                                            <svg width="18" height="18" viewBox="0 0 18 18" className="fill-current">
                        ...
                        <div className="mb-9 overflow-hidden rounded-lg bg-white shadow-card">
                            ...
                            <div className="items-center justify-between border-t border-[#e7e7e7] px-6 pt-4 md:flex md:px-8 xl:px-10">
                                <div className="mb-4 flex items-center">
                                    <div className="mr-4 h-10 w-10 overflow-hidden rounded-full">
                                        <img src="/img/image-03.png" alt="author" className="h-full w-full object-cover object-center" />
                                    </div>
                                    <div className="flex items-center">
                                        <h3 className="pr-2 text-lg font-medium text-black">
                                            Wilium Heli
                                ...
                                <form>
                                    <div className="-mx-3 flex flex-wrap">
                                        <div className="w-full px-3 sm:w-1/2">
                                            <div className="mb-6">
                                                <input type="text" placeholder="First Name" className="w-full rounded-lg border border-[#e7e7e7] bg-[#f4f7ff] py-3 px-6 font-medium text-slate-700 placeholder-slate-700 outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-[#F5F7FD]" />
                                            </div>
                                        </div>
                                        <div className="w-full px-3 sm:w-1/2">
                                            <div className="mb-6">
                                                <input type="text" placeholder="Last Name" className="w-full rounded-lg border border-[#e7e7e7] bg-[#f4f7ff] py-3 px-6 font-medium text-slate-700 placeholder-slate-700 outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-[#F5F7FD]" />
                                            </div>
                                        </div>
                                        <div className="w-full px-3">
                                            <div className="mb-6">
                                                <input type="text" placeholder="Type review headline" className="w-full rounded-lg border border-[#e7e7e7] bg-[#f4f7ff] py-3 px-6 font-medium text-slate-700 placeholder-slate-700 outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-[#F5F7FD]" />
                                            </div>
                                        </div>
                                        <div className="w-full px-3">
                                            <div className="mb-6">
                                                <textarea rows="6" placeholder="Write your Review" className="w-full rounded-lg border border-[#e7e7e7] bg-[#f4f7ff] py-3 px-6 font-medium text-slate-700 placeholder-slate-700 outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-[#F5F7FD]"></textarea>
                                            </div>
                                        </div>
                                        <div className="w-full px-3">
                                            <div>
                                                <button className="inline-flex items-center justify-center rounded-md bg-blue-600 py-3 px-8 text-center text-base font-semibold text-white hover:bg-opacity-90">
                                                    Submit Review
                                                </button>
                                            </div>
                                        </div>
