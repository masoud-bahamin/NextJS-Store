                        ...
                        <div className="w-full px-4 md:w-1/3">
                            <div className="mb-[60px] text-center md:mt-[60px]">
                                ...
                                <div>
                                    ...
                                    <p className="text-base font-medium text-slate-800 md:text-sm lg:text-base">
                ...
                <div className="container mx-auto">
                    <div className="-mx-4 flex flex-wrap">
                            ...
                            <div className="mb-16 max-w-[270px]">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="flex text-base font-medium text-slate-800">
                                        <span className="pr-4">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M21.0227 4H3.97727C2.88636 4 2 4.98345 2 6.19385V17.8061C2 19.0165 2.88636 20 3.97727 20H21.0227C22.1136 20 23 19.0165 23 17.8061V6.19385C23 4.98345 22.1136 4 21.0227 4ZM21.0227 5.32388C21.1932 5.32388 21.3295 5.3617 21.4659 5.47518L12.9773 11.1868C12.6705 11.3759 12.3295 11.3759 12.0227 11.1868L3.53409 5.47518C3.67045 5.39953 3.80682 5.32388 3.97727 5.32388H21.0227ZM21.0227 18.6383H3.97727C3.56818 18.6383 3.19318 18.26 3.19318 17.7683V6.79905L11.375 12.3215C11.7159 12.5485 12.0909 12.6619 12.4659 12.6619C12.8409 12.6619 13.2159 12.5485 13.5568 12.3215L21.7386 6.79905V17.7683C21.8068 18.26 21.4318 18.6383 21.0227 18.6383Z" fill="#3056D3"></path>
                                            </svg>
                                        </span>
                        ...
                        <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                            <div className="mb-16">
                                <h3 className="mb-9 text-2xl font-semibold text-black">My Account</h3>

                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" className="inline-block text-base font-medium text-slate-800 hover:text-blue-600">
                                            My Profile
                                        </a>
                                    </li>
                                    <li>
            ...
            <div className="border-t border-[#e7e7e7] py-7">
                <div className="container mx-auto">
                    <div className="text-center">
                        <div className="mb-5">
                            <img src="/img/payment.svg" alt="payment" className="mx-auto max-w-full" />
                        </div>
