                ...
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div className="mx-auto mb-10">
                            ...
                            <div>
                                <span className="mb-5 inline-block rounded bg-blue-600 py-1 px-4 text-center text-xs font-semibold leading-loose text-white">
                                    Dec 22, 2023
                                </span>
                                <h3>
                                    <a href="#" className="mb-4 inline-block text-xl font-semibold text-slate-900 hover:text-blue-600 sm:text-2xl lg:text-xl xl:text-2xl">
