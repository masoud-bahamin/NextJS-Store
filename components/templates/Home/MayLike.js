        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <span className="mx-auto mb-4 block h-1 w-24 bg-primary-300"></span>
        ...
        <div>
          <div className="relative flex justify-center">
            <div className="relative w-full pb-14">
              <div
                className="flex-no-wrap snap mx-auto flex h-auto w-full max-w-[300px] overflow-hidden transition-all xs:max-w-[400px] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px]"
                x-ref="carousel"
              >
                {likesProducts.map((product) => (
                  <ProductSlid {...product} key={product._id} />
                ))}
              </div>
              <div className="absolute left-0 right-0 bottom-0 flex items-center justify-center space-x-3">
                <button className="flex h-10 w-10 items-center justify-center rounded-full border border-body-color bg-white text-body hover:border-primary-300 hover:bg-primary-300 hover:text-white">
                  <svg
                    width="15"
                    height="13"
                    viewBox="0 0 15 13"
