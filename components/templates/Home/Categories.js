          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
            <a href="#" className="group mb-10 block text-center">
              <div className="mb-5 overflow-hidden rounded-lg">
                <img
                  src="/img/image-011.jpg"
                  alt="category"
                  className="w-full"
                />
              </div>
              <h3 className="mb-1 text-xl font-semibold text-black group-hover:text-primary-300 md:text-2xl lg:text-xl xl:text-2xl">
                Accessories
              </h3>
