      ...
      <div className="mt-3 inline-flex rounded bg-white p-3 shadow-md">
        <ul className="-mx-[6px] flex items-center">
          <li className="px-[6px]">
            <a
              href="#"
              className="flex h-6 w-6 items-center justify-center rounded text-base text-[#838995] hover:bg-[#EDEFF1]"
            >
              <span>
                <svg
                  width="5"
          ...
          <li className="px-[6px]">
            <a
              href="#"
              className="flex h-6 w-6 items-center justify-center rounded bg-primary-300 text-base text-white"
            >
              1
            </a>
          </li>
          ...
          <li className="px-[6px]">
            <a
              href="#"
              className="flex h-6 w-6 items-center justify-center rounded text-base text-[#838995]"
            >
              ...
            </a>
          </li>
